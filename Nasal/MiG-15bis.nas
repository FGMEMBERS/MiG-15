...
gearmove = func 
	{
		...
		if (gear_two_tored==0)
		{
			if (gear_two_stuck==0)
			{
				timedhmove("/fdm/jsbsim/gear/unit[1]/pos-norm", "/fdm/jsbsim/gear/gear-cmd-norm-real", 5.0);
				timedhmove("/gear/gear[1]/position-norm", "/fdm/jsbsim/gear/gear-cmd-norm-real", 5.0);
				if (
					(speed_km>355) 
					and (gear_two_pos>0)
...
realelectric=func
	{
		...
		set_tanks_drop=getprop("/controls/switches/drop-tank");
		...
		if (battery_time>60)
		{
			...
			switchswap("/instrumentation/switches/battery");
		}
		...
		if (bus_on==1)
		{
			...
			setprop("/systems/electrical-real/outputs/drop-tank/on", set_tanks_drop);
			setprop("/systems/electrical-real/outputs/drop-tank/volts-norm", set_tanks_drop);
